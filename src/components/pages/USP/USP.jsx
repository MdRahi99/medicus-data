...
const USPCard = ({ icon: Icon, title, shape, onSeeMore }) => {
  return (
    <div className="flex flex-col items-center p-6 rounded-lg w-64 border transition-all duration-300 hover:shadow-lg relative overflow-hidden bg-white group h-64 mx-2">
  ...
  return (
    <div className="py-16 md:py-24 px-4 md:px-16 bg-gradient-to-b from-white to-gray-100">
      <div className="">
        ...
        <Marquee gradientWidth={50} speed={50} pauseOnHover={true}>
          {usps.map((usp, index) => (
            <USPCard
              key={index}
              {...usp}
